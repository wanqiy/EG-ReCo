...
def train_rl(args, model_rl, train_features, dev_features):
...
def main():
    ...
    model_rl = Agent(config, model, tokenizer,
                       num_labels=args.num_labels,
                       max_sent_num=args.max_sent_num,
                       evi_thresh=args.evi_thresh)
    ...
    if args.do_train:  # Training
    ...
    elif args.do_train_rl:

        model_rl.to(args.device)
        ...
        train_rl(args, model_rl, train_features, dev_features)
