...
class DocREModel(nn.Module):
    ...
    def __init__(self, config, model, tokenizer,
                ...
                max_sent_num=25, evi_thresh=0.2,threshold=0.85):
        '''
    ...
    def forward_rel(self, hs, ts, rs, logits_with_labelinfo):
        '''
    ...
    def forward(self,
        ...
        logits = self.forward_rel(hs, ts, rs,logits_with_labelinfo)
